    ...
    <header className="fixed top-0 left-0 right-0 z-50 bg-surface text-background border-b border-background/10">
      <div className="container-wide flex items-center justify-between py-4 nav:py-5">
        ...
        <div className="hidden nav:flex items-center gap-5">
          ...
          <Link
            to={link("contact")}
            className="border border-background text-background font-medium text-sm px-[28px] py-[14px] rounded-full hover:bg-brand hover:text-background hover:border-brand transition-colors"
          >
            {t("nav.contactUs")}
          </Link>
        </div>
        ...
        <div className="nav:hidden flex items-center gap-3 z-50">
          ...
          <Link
            to={link("contact")}
            className="border border-background text-background font-medium text-xs px-[20px] py-[10px] rounded-full hover:bg-brand hover:text-background hover:border-brand transition-colors"
          >
            {t("nav.contactUs")}
          </Link>
          <button
