  ...
  return (
    <section className="relative min-h-[88vh] md:min-h-screen overflow-hidden bg-secondary">
      ...
      <img
        ...
        fetchPriority="high"
        decoding="sync"
        className="absolute inset-0 w-full h-full object-cover object-[72%_15%] md:object-[75%_22%] lg:object-[68%_22%] hero-img-fade"
      ...
      <div className="absolute inset-0 bg-[linear-gradient(to_right,hsl(192_38%_10%/0.95),hsl(192_38%_10%/0.55)_45%,transparent_85%)]" />
      ...
      <div className="relative z-10 min-h-[88vh] md:min-h-screen flex flex-col container-wide">
        <div className="flex-1 flex items-end lg:items-center pb-[89px] md:pb-[140px] lg:pb-[100px]" style={{ paddingTop: 'calc(var(--nav-h) + clamp(48px, 6vw, 88px))' }}>
