...
const HeroSection = () => {
  ...
  return (
    <section className="relative min-h-[56vh] md:min-h-[75vh] overflow-hidden bg-secondary">
      ...
      <img
        ...
        fetchPriority="high"
        decoding="sync"
        className="absolute left-0 right-0 top-[120px] w-full h-[calc(100%+120px)] object-cover object-[95%_30%] hero-img-fade"
      />
      <div className="absolute inset-0 bg-gradient-to-r from-black/85 via-black/60 to-black/20" />

      <div className="relative z-10 min-h-[56vh] md:min-h-[75vh] flex flex-col container-wide">
