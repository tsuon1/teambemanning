    ...
    <section className="bg-secondary section-padding">
      <div className="container-wide">
        ...
        <div className="text-center mt-10">
          <Link to="/nyheter" className="inline-flex items-center border border-foreground text-foreground font-medium text-sm px-7 py-2.5 rounded-[2px] hover:bg-foreground hover:text-background transition-colors">
