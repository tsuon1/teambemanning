  ...
  return (
    <section className="bg-background flex items-center justify-center" style={{ padding: '15vh 0' }}>
      <div className="container-wide text-center">
        ...
        <Link to="/kontakt" className="inline-flex items-center gap-2 border border-foreground text-foreground font-medium text-sm px-7 py-3 rounded-[2px] hover:bg-foreground hover:text-background transition-colors">
