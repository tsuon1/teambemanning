  ...
  return (
    <section className="bg-background flex items-center justify-center" style={{ padding: '15vh 0' }}>
      <div className="container-wide text-center">
        ...
        <Link to="/kontakt" className="inline-flex items-center gap-2 bg-brand text-white font-medium text-sm px-7 py-3 rounded-none hover:scale-105 transition-transform">
